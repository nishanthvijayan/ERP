...
class EditUserForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		# self.fields['password1'].widget = forms.PasswordInput(attrs={'class': 'form-control'}, render_value=True)
		# self.fields['password2'].widget = forms.PasswordInput(attrs={'class': 'form-control'}, render_value=True)
...
# class GroupMembers(Group):
# 	users = models.ManyToManyField(User, blank=True)

class EditGroupForm(forms.ModelForm):

	# users = Group.user_set.get_queryset()
