# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-15 19:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('station_visited', models.CharField(help_text=b'Mention the station visited', max_length=100)),
                ('fair_paid', models.DecimalField(decimal_places=2, help_text=b'Enter the amount paid for fair for both ways', max_digits=10)),
                ('expenditure', models.DecimalField(decimal_places=2, help_text=b'Enter the amount paid for boarding and lodging', max_digits=10)),
                ('purpose_visit', models.CharField(help_text=b'Mention the purpose of visit', max_length=100)),
                ('approval', models.ImageField(blank=True, help_text=b'attach image of approval of director or HOD if obtained?', null=True, upload_to=b'')),
                ('information', models.CharField(blank=True, help_text=b'Any other information', max_length=100, null=True)),
                ('amount_spent', models.DecimalField(decimal_places=2, help_text=b'Enter the amount spent on local journey', max_digits=10)),
                ('advance_taken', models.DecimalField(decimal_places=2, help_text=b'Enter the advance amount taken', max_digits=10)),
                ('reimbursement_amount', models.DecimalField(decimal_places=2, help_text=b'Enter the amount of reimbursement', max_digits=10)),
                ('amount_passed', models.DecimalField(decimal_places=2, help_text=b'Enter amount that passed ', max_digits=10, null=True)),
                ('cheque_no', models.PositiveIntegerField(help_text=b'Enter cheque no.', null=True)),
        ...
        migrations.CreateModel(
            name='ProfessionalTourTransitionHistory',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ...
                ('state_to', django_fsm.FSMField(blank=True, default=b'Submitted', max_length=50)),
                ('remarks', models.CharField(blank=True, help_text=b'Remarks', max_length=300, null=True)),
                ('approved_by', models.ForeignKey(help_text=b'Employee', on_delete=django.db.models.deletion.CASCADE, related_name='professional_tour_transition_history', to=settings.AUTH_USER_MODEL)),
                ('professional', models.ForeignKey(help_text=b'Professional Tour', on_delete=django.db.models.deletion.CASCADE, related_name='professional_tour_transition_history', to='reimbursement.ProfessionalTour')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            ...
            name='professional_tour',
            field=models.ForeignKey(help_text=b'', on_delete=django.db.models.deletion.CASCADE, to='reimbursement.ProfessionalTour'),
        ),
        migrations.AddField(
