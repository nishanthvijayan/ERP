...
import django_fsm
import reimbursement.models.medical.medical_detail.medical_bill
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_claimed_medicine', models.DecimalField(blank=True, decimal_places=2, help_text=b'The amount claimed for the medicines, if any', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('amount_claimed_test', models.DecimalField(blank=True, decimal_places=2, help_text=b'The amount claimed for the tests, if any', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('amount_claimed_room_rent', models.DecimalField(blank=True, decimal_places=2, help_text=b'The amount claimed for room rented, if any', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('amount_claimed_other', models.DecimalField(blank=True, decimal_places=2, help_text=b'Others, Ex :- Operation, Procedure, ICU / CCU/ Consultation / Others)', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('other_expenses', models.CharField(blank=True, help_text=b'Please specify, Ex :- Operation, Procedure, ICU / CCU / Others)', max_length=150, null=True)),
                ('amount_passed_medicine', models.DecimalField(blank=True, decimal_places=2, help_text=b'The amount passed for the medicines, if any', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('amount_passed_test', models.DecimalField(blank=True, decimal_places=2, help_text=b'The amount passed for the tests, if any', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('amount_passed_room_rent', models.DecimalField(blank=True, decimal_places=2, help_text=b'The amount passed for room rented, if any', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('amount_passed_other', models.DecimalField(blank=True, decimal_places=2, help_text=b'Others, Ex :- Operation, Procedure, ICU / CCU / Others)', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('total_amount_claimed', models.DecimalField(blank=True, decimal_places=2, help_text=b'Total amount claimed', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('total_amount_passed', models.DecimalField(blank=True, decimal_places=2, help_text=b'Total amount passed', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('total_amount_rejected', models.DecimalField(blank=True, decimal_places=2, help_text=b'Total amount rejected', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('image_file', models.ImageField(help_text=b'Upload Image of bills', upload_to=reimbursement.models.medical.medical_detail.medical_bill.generate_filename)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount_claimed', models.DecimalField(decimal_places=2, help_text=b'Mention total claim amount', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('less_advance_taken', models.DecimalField(blank=True, decimal_places=2, help_text=b'Mention Less advance taken before', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('net_amount_claimed', models.DecimalField(decimal_places=2, help_text=b'Enter net amount, ie Total - Less Amount', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
