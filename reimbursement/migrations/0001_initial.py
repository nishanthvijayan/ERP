    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_passed', models.DecimalField(decimal_places=2, help_text=b'Enter amount that passed ', max_digits=10)),
                ('cheque_no', models.PositiveIntegerField(help_text=b'Enter cheque no.')),
