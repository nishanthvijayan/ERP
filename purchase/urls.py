...
urlpatterns = [
    ...
    url(r'^requests/(?P<request_id>[0-9]+)/approve$',
        views.purchase_indent_approve, name='purchase-indent-approve'),
    url(r'^requests/(?P<request_id>[0-9]+)/approve_hod$',
        views.purchase_indent_hod_approve, name='purchase-indent-hod-approve'),
    url(r'^requests/(?P<request_id>[0-9]+)/approve_jao$',
