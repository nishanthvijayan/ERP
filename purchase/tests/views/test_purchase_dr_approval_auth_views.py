"""Test cases for testing authorization for Approval/Rejection by DR."""
...
class PurchaseApprovalDRViewTests(TestCase):
    """Test cases for testing authorization for Approval/Rejection by DR."""
    ...
    def test_purchase_indent_dr_approve_as_employee(self):
        """Employee who is not DR should not be able to Approve/Reject form Approved by JAO."""
        ...
        response = self.client.post(reverse('purchase:purchase-indent-dr-approve',
    ...
    def test_purchase_indent_dr_approve_as_hod(self):
        """Employee(HOD) who is not DR should not be able to Approve/Reject form Approved by JAO."""
    ...
    def test_purchase_indent_dr_approve_as_jao(self):
        """Employee(JAO) who is not DR should not be able to Approve/Reject form Approved by JAO."""
    ...
    def test_purchase_indent_dr_approve_as_dr(self):
        """Employee who is DR should be able to Approve form Approved by JAO."""
    ...
    def test_purchase_indent_dr_reject_as_dr(self):
        """Employee who is DR should be able to Reject form Approved by JAO."""
        response = self.client.post(reverse('home:login'), {'username': 'dr_employee', 'password': 'qweasdzxc'})
        form = PurchaseIndentRequest.objects.create(indenter=self.employee, project_name="Project",
                                                    budget_head="Institute",
                                                    state="Approved by Junior Accounts Officer")
